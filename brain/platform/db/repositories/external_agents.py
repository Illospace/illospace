...
class ExternalAgentConnectionRepository(BaseRepository[ExternalAgentConnectionRow]):
    ...
    async def a_list_for_org(
        self,
        org_id: str,
        *,
        owner_user_id: str | None = None,
    ) -> Sequence[ExternalAgentConnectionRow]:
        stmt = (
...
class ExternalAgentConnectionTokenRepository(BaseRepository[ExternalAgentConnectionTokenRow]):
    ...
    async def a_get_by_hash(self, token_hash: str) -> ExternalAgentConnectionTokenRow | None:
        return (
...
class ExternalAgentTaskRepository(BaseRepository[ExternalAgentTaskRow]):
    ...
    async def a_list_for_connection(
        self,
        connection_id: str,
        *,
    ...
    async def a_list_for_idea(self, idea_id: str, *, limit: int = 50) -> Sequence[ExternalAgentTaskRow]:
        stmt = (
            select(ExternalAgentTaskRow)
...
class ExternalAgentTaskEventRepository(BaseRepository[ExternalAgentTaskEventRow]):
    ...
    async def a_list_for_task(self, task_id: str, *, limit: int = 200) -> Sequence[ExternalAgentTaskEventRow]:
        stmt = (
...
class ExternalAgentTaskArtifactRepository(BaseRepository[ExternalAgentTaskArtifactRow]):
    ...
    async def a_list_for_task(self, task_id: str) -> Sequence[ExternalAgentTaskArtifactRow]:
        stmt = (
