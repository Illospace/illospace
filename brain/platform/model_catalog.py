...
MODEL_CATALOG: tuple[ModelCatalogEntry, ...] = (
    ...
    ModelCatalogEntry(
        ...
        label="GPT-5.5",
        provider="openai",
        description="Availability fallback for GPT-5.6 Sol.",
        supported_effort_tiers=_ALL_EFFORT_TIERS,
    ...
    ModelCatalogEntry(
        ...
        label="GPT-5.4 Pro",
        provider="openai",
        description="Maximum-quality API-key route.",
        supported_effort_tiers=_ALL_EFFORT_TIERS,
        availability_fallback=None,
        context_window_tokens=400_000,
    ...
    ModelCatalogEntry(
        ...
        label="GPT-5.4",
        provider="openai",
        description="Balanced general-purpose API-key route.",
        supported_effort_tiers=_ALL_EFFORT_TIERS,
        availability_fallback=None,
    ...
    ModelCatalogEntry(
        ...
        label="GPT-5.4 Mini",
        provider="openai",
        description="Fast API-key route for lighter tasks.",
        supported_effort_tiers=_ALL_EFFORT_TIERS,
        availability_fallback=None,
        context_window_tokens=128_000,
    ...
    ModelCatalogEntry(
        ...
        label="GPT-5.4 Nano",
        provider="openai",
        description="Small low-latency API-key route.",
        supported_effort_tiers=_ALL_EFFORT_TIERS,
        availability_fallback=None,
        context_window_tokens=128_000,
    ...
    ModelCatalogEntry(
        ...
        label="GPT-5 Mini",
        provider="openai",
        description="Low-cost API-key route.",
        supported_effort_tiers=_ALL_EFFORT_TIERS,
        availability_fallback=None,
        context_window_tokens=128_000,
    ...
    ModelCatalogEntry(
        ...
        label="GPT-5 Nano",
        provider="openai",
        description="Smallest OpenAI API-key route.",
        supported_effort_tiers=_ALL_EFFORT_TIERS,
        availability_fallback=None,
        context_window_tokens=128_000,
        input_price_per_million=0.05,
