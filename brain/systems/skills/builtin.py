...
""",
    ...
    "orchestrate": _skill(
        name="orchestrate",
        description=(
            "Delegate independent deliverables with spawn_worker, collect every "
            "child result honestly, and verify the final outcome."
        ),
        procedure="""
## Role
...
""",
        ...
        guardrails=[
            ...
            _guardrail("An unread worker does not count as completed work.", "high"),
        ],
        pitfalls=[
            {"severity": "high", "text": "A queued or terminal child is not evidence until its result has been read."},
            {"severity": "high", "text": "Parallelism without disjoint ownership creates merge conflicts and duplicated work."},
            {"severity": "high", "text": "Prompt-only assignment fields can be mistaken for runtime enforcement."},
            {"severity": "warning", "text": "Worker summaries beyond the workspace snippet cap can hide required evidence."},
        ],
        refinements=[
            {"text": "Use a high-effort director with cheaper readers for clear workhorse tasks."},
            {"text": "Self-cover every missing delegated slice before finalizing."},
        ],
    ),
