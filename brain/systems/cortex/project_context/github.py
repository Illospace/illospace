...
GITHUB_AI_TRIAGE_PROVENANCE_BANNER = "> *This was generated by AI during triage.*"
...
def _comment_authorship(body: str) -> str:
    ...
    banner = first_line[1:].lstrip()
    expected = GITHUB_AI_TRIAGE_PROVENANCE_BANNER[1:].lstrip()
    expected_without_period = expected.removesuffix(".*") + "*"
    if banner.casefold() in {expected.casefold(), expected_without_period.casefold()}:
        return "automation"
