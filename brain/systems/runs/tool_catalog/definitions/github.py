            ...
            "properties": {
                "action": {
                    ...
                    "description": (
                        ...
                        "Issue comments return authorship: automation means the body starts with the AI triage "
                        "provenance banner, and unknown means authorship could not be determined; unknown does "
                        "not mean human. "
