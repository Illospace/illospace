...
WORKER_SPAWN_TOOLS = [
    {
        ...
        "description": (
            ...
            "Reasoning/judgment/review/long-context work: openai/gpt-6-astra, routed by effort "
            "(xhigh judgment, high standard; minimum low). openai/gpt-5.6-sol is its availability "
            "fallback and an explicit option for standard reasoning or chatty tool loops. "
