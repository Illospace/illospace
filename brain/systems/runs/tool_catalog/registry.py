...
_STATIC_METADATA: dict[str, dict[str, Any]] = {
    ...
    "join_meeting": {
        ...
        "reversibility": "variable",
        "action_manifest": True,
        "expected_effect": "ask the configured meetbot to join one external Google Meet",
        "output_budget_chars": 4_000,
    },
    "meeting_status": {
        "permission": "network_read",
        ...
        "parallel_safety": "agent_safe",
        "evidence_emitter": True,
        "expected_effect": "read the current state of one external meetbot session",
        "output_budget_chars": 6_000,
    },
    "leave_meeting": {
        "permission": "write_workspace",
        ...
        "reversibility": "variable",
        "action_manifest": True,
        "expected_effect": "ask meetbot to leave an external meeting and finalize its transcript",
        "output_budget_chars": 4_000,
    },
    "send_meeting_chat": {
        ...
        "reversibility": "append_only",
        "action_manifest": True,
        "expected_effect": "post visible text into an active external meeting chat",
        "output_budget_chars": 4_000,
    },
    "manage_soul": {
