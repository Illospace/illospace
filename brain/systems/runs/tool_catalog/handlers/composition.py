...
def _get_tool_handlers(
    ...
    handlers = {
        ...
        "browser_session_open": _handle_browser_session_open,
        "browser_navigate": _handle_browser_navigate,
        "browser_click": _handle_browser_click,
        "browser_type": _handle_browser_type,
        "browser_key": _handle_browser_key,
        "browser_back": _handle_browser_back,
        "browser_forward": _handle_browser_forward,
        "browser_new_tab": _handle_browser_new_tab,
        "browser_switch_tab": _handle_browser_switch_tab,
        "browser_close_tab": _handle_browser_close_tab,
        "browser_list_tabs": _handle_browser_list_tabs,
        "browser_wait": _handle_browser_wait,
        "browser_extract": _handle_browser_extract,
        "browser_discover": _handle_browser_discover,
        "browser_upload_attachment": _handle_browser_upload_attachment,
        "browser_snapshot": _handle_browser_snapshot,
        "browser_save_screenshot": _handle_browser_save_screenshot,
        "browser_print_pdf": _handle_browser_print_pdf,
