...
_FIRST_PARTY_CAPABILITY_SPECS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "summary": "Illo can read bounded GitHub repository metadata, issues, pull requests, deploy ancestry, and native parent/sub-issue relationships, and can open or link real issues when a write-capable token can reach the repos.",
        "aliases": ("github", "issues", "pull requests", "prs", "repo tickets", "source repo", "create issue", "open issue", "file a ticket", "sub-issues", "parent issue", "chantier mirror"),
        "tools": (
            "read_github_source",
    ...
    },
    {
        ...
        "name": "Memory",
        "category": "agent_runtime",
        "summary": "Illo can reconstruct and ingest source-backed long-term memory evidence, lessons, facts, patterns, episodes, and guardrails.",
        "aliases": ("memory", "memories", "remember", "lessons", "guardrails"),
        "tools": ("brain_recall", "brain_encode", "memory_reconstruct", "memory_ingest_source", "brain_guardrails"),
    },
    {
