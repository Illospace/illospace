...
_FIRST_PARTY_CAPABILITY_SPECS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "summary": "Illo can read bounded GitHub repository metadata, issues, pull requests, pinned source files, trees, literal grep citations, deploy ancestry, and native parent/sub-issue relationships, and can create, update, comment on, or link real issues when a write-capable token can reach the repos.",
        "aliases": ("github", "issues", "pull requests", "prs", "repo tickets", "source repo", "source files", "code search", "grep", "create issue", "open issue", "file a ticket", "update issue", "assign issue", "comment on issue", "issue comment", "labels", "sub-issues", "parent issue", "chantier mirror"),
        "tools": (
            "read_github_source",
