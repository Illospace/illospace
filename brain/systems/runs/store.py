...
class SyncAgentRunStore:
    """Sync persistence boundary for agent runs."""
    ...
    def append_event(self, event: AgentRunEvent) -> AgentRunEventRow:
        ...
        row = AgentRunEventRow(
            ...
            if isinstance(event.visibility, EventVisibility)
...
__all__ = ["AsyncAgentRunStore", "SyncAgentRunStore", "to_domain"]
