...
@pytest.mark.parametrize(
    ...
    [
        ...
        ">*This was generated by AI during triage*\nResult.",
        "> *This was generated by AI during an autonomous run.*\nResult.",
        "> *This was generated by AI during a routine run.*\nResult.",
        "> *This was generated by AI during an autonomous R3 run.*\nResult.",
        "> *This was generated by AI during triage (pilot sweep, 2026-08-19).*\nResult.",
    ],
    ids=[
        "leading_blanks_and_case",
        "no_blockquote_space_or_period",
        "autonomous_run",
        "routine_run",
        "autonomous_r3_run",
        "triage_with_parenthetical",
    ],
)
def test_issue_comment_payload_accepts_every_banner_seen_in_the_wild(body):
    # All five spellings were counted on live issues. Only the opening is invariant.
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "> Deploy note: this was generated by AI during triage.",
    ],
    ids=["no_blockquote", "banner_after_prose", "different_text", "banner_not_at_line_start"],
)
def test_comment_authorship_keeps_the_banner_match_narrow(body):
    # The match stays anchored: the banner must open the FIRST non-empty line, as a
    # blockquote, with the exact provenance wording. These cases must stay "unknown"
    # so a later change cannot widen matching without a test turning red.
