...
async def test_cycle_tool_and_external_agent_events_share_the_same_intake_policy(monkeypatch):
    ...
    events = [
        WorkIntakeEvent(
            ...
            payload={
                ...
                "metadata": {"execution_profile": "deep", "model": "openai/gpt-5.6-sol"},
            },
    ...
    assert requests[0].model_policy["model"] == "openai/gpt-5.6-sol"
...
async def test_external_headless_ask_uses_async_work_intake_policy():
    ...
    request = await build_agent_run_request(
        ...
        WorkIntakeEvent(
            ...
            payload={
                ...
                "model_policy": {"model": "openai/gpt-5.6-sol", "thinking": "medium"},
                "metadata": {
    ...
    assert request.model_policy == {"model": "openai/gpt-5.6-sol", "thinking": "medium"}
