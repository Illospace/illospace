...
from brain.platform.db.models.vault import Secret, VaultAgentGrant
...
async def session(async_sqlite_session_factory):
    s = await async_sqlite_session_factory(
        [Org.__table__, User.__table__, Secret.__table__, VaultAgentGrant.__table__],
...
async def test_agent_secret_read_without_run_is_denied(patch_uow):
