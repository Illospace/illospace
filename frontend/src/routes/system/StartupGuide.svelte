...
<ConstellationPanel className="startup-guide" tone={guideTone} ariaLabel="First setup">
  <div class="guide-shell">
      ...
      <div class="guide-copy">
        ...
        <p>
          {#if canManageSettings}
            Set up this Illo installation once. Access, models, and memory become the runtime baseline.
          {:else}
            An owner or admin needs to finish this installation setup.
          {/if}
        </p>
      </div>
    ...
    <p class="guide-note">Memory is installation-wide. Choose once; changing later requires a rebuild.</p>
  </div>
</ConstellationPanel>
